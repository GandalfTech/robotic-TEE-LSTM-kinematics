...
lw_pred = 1    # thickness (if using lines) for predicted trajectories
...
# color_p0   = '#7fb3d5'  # 0° predicted
# color_p45  = 'gray'     # 45° predicted
# color_p90  = '#e74c3c'  # 90° predicted
# # Base marker
...
# Predicted trajectories (markers only)
